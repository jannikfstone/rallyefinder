...
The supported body for sending filters are:
```
{
...
```
This will return a JSON with a searchId. You can use this ID to query the results of the search.
